...
Estou usando o metodo da rejeiço $Y\sim U(0,1)$ assim $c=\displaystyle\frac{e^{1}}{(e^y-1)}$ $\rightarrow$ $h(y)=e^y-1$.
```{r}
f1 <- function( ){
  y <- runif(1)
  u1 <- runif(1)
...
Estou usando o metodo da rejeição $Y\sim U(0,1)$ assim $c=\frac{e^{1}}{(e^{y}-1)}$ ==> $h=e^{y}-1$
